...
# Identifier visuellement les jours avec des variations extrêmes
seuils_extremes = [15, -15]  

# Choisissez vos seuils de variation extrême
extremes = df[(df['Rendement Quotidien'] > seuils_extremes[0]) | (df['Rendement Quotidien'] < seuils_extremes[1])]

plt.scatter(extremes['Date'], extremes['Close'], c='red', marker='^', label='Variations Extrêmes')
plt.legend()
plt.show()